    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                Console.WriteLine("Introducir ejercicio: 4-23");
                ejercicio = int.Parse(Console.ReadLine());

                if (ejercicio >= 4 && ejercicio <= 23)
                {
                    Console.WriteLine();
                }
                else
                ...
                else if (ejercicio == 15)
                {
                    ...
                    if (litros <= 50)
                    {
                        Console.WriteLine("El pago seria de " + pago);
                    }
                    ...
                    {
                        pago = 45;
                        Console.WriteLine("El pago final seria de " + pago);
                    }
                ...
                else if (ejercicio == 17)
                {
                    ...
                    else
                    {
                        ...
                        double tasaExtra = tasaporhora + 0.5 * tasaporhora;
                        salariobruto = 38 * tasaporhora + horasExtra * tasaExtra;
                        Console.WriteLine("El salario bruto seria de: " + salariobruto);
                    }
                    if (salariobruto <= 300)
                    {
                        salarioneto = salariobruto;
                        Console.WriteLine("El salario neto seria de: " + salarioneto);
                    }
                    else
                    {
                ...
                else if (ejercicio == 18)
                {
                    ...
                    //Escribe una instrucción switch que examine el valor de una variable entera llamada “indicador”
                    //y escriba uno de los siguientes mensajes:
                    ...
                    Console.WriteLine("Introduzca el indicador del 1-4");
                    double indicador = double.Parse(Console.ReadLine());
                ...
                else if (ejercicio == 19)
                {
                    ...
                    Console.WriteLine("Elija el caracter del color");
                    Console.WriteLine("r o R = ROJO");
                    Console.WriteLine("v o V = VERDE");
                    Console.WriteLine("a o A = AZUL");
                    Console.WriteLine("cualquier otro caracter = NEGRO");
                ...
                Console.WriteLine("quiere escoger otro ejercicio? : s-> si/ n-> no");
